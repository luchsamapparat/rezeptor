import type { ContainerRequest, Database, ItemDefinition, PartitionKey, SqlQuerySpec } from '@azure/cosmos';
import { PartitionKeyBuilder } from '@azure/cosmos';
import type { TelemetryClient } from 'applicationinsights';
import type { EntityId } from './Entity';
import type { GenericItemContainer, ItemContainer } from './ItemContainer';
